...
void* (*malloc_fun)(size_t size) = NULL;

extern void* (*realloc_fun)(void *b, size_t bytes);
void* (*realloc_fun)(void *b, size_t bytes) = NULL;

extern void (*free_fun)(void* ptr);
void (*free_fun)(void *ptr) = NULL;

extern void* (*memset_fun)(void *b, int c, size_t len);
void* (*memset_fun)(void *b, int c, size_t len) = NULL;

extern void* (*memmove_fun)(void *dst, const void *src, size_t len);
void* (*memmove_fun)(void *dst, const void *src, size_t len) = NULL;
